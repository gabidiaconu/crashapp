package com.example.user.rv_android.service.gps;
...
import com.example.user.rv_android.db.DataHelper;
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (OSMTracker.INTENT_TRACK_WP.equals(intent.getAction())) {
				...
				if (extras != null) {
					...
					if (ActivityCompat.checkSelfPermission(GPSLogger.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(GPSLogger.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
