package com.example.user.rv_android.gpx;
...
import com.example.user.rv_android.exception.ExportTrackException;
...
public abstract class ExportTrackTask  extends AsyncTask<Void, Integer, Boolean> {
	 ...
	 */
	protected abstract File getExportDirectory(Date startDate) throws ExportTrackException, ExportTrackException;
